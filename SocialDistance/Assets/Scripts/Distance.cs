...
public class Distance : MonoBehaviour
{
    ...
    [SerializeField]
    FritzVisionUnity fritzVisionUnity;

    [SerializeField] GameObject distancePlane;
    ...
    void Update()
    {
        if(fritzVisionUnity.isTracked)
        {
            distancePlane.SetActive(true);
        ...
        else
        {
            warning.SetActive(false);
            info.SetActive(false);
            distancePlane.SetActive(false);

            measurementtxt.color = Color.blue;
            measurementtxt.SetText("Searching human to scan...");
        }
    }
